...
public class Constants 
{
    ...
    public static final Angle HARDCODE_HOOD_PITCH = Degrees.of(69.5);
    public static final double HARDCODE_VELOCITY = 9.4 - 0.25;
    ...
    public static final double AUTO_SHOOT_1_VELOCITY = 8.9 + 0.4;
