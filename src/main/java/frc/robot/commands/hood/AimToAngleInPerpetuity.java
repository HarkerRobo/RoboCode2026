...
public class AimToAngleInPerpetuity extends Command
{
     ...
     * @param pitch degrees
     */
    public AimToAngleInPerpetuity(DoubleSupplier pitcher)
    {
     ...
     */
    public AimToAngleInPerpetuity(double pitch)
    {
        this(() -> pitch);
    }
    ...
    {
        return "AimToAngleInPerpetuity (" + pitch + "°)";
    }
}
